...
def _parse_init_data(init_data: str) -> dict[str, str]:
    ...
    # Telegram fields are unique. Rejecting duplicates prevents ambiguous
    # canonicalization between signature verification and later extraction.
...
def validate_init_data(
    ...
    # A small allowance covers ordinary clock skew without accepting a signed
    # payload whose authentication timestamp is materially in the future.
